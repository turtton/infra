...
| 項目 | 状態 |
|------|------|
| ICX7250 | 稼働中。VLAN 2 (192.168.11.2/24, Buffalo経由) でUPLINK、VLAN 10 (192.168.10.1/24) でLAN提供中 |
...
> **注意**: ISPルーター (192.168.1.1) が static route 非対応のため、Buffalo (192.168.11.1) がNATルーターとして中継している。
> 11.0/24クライアントのデフォルトGWはICX (11.2)。インターネットはICX→Buffalo→ISPルーター経由。
...
Buffalo (192.168.11.1)
    │
    ├── port 47-48 (VLAN 2: UPLINK, 192.168.11.0/24)
    │
ICX7250 (ve2: 192.168.11.2, ve10: 192.168.10.1)
    │
